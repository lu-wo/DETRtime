    ...
    def forward(self, outputs, targets):
        ...
        Params:
            outputs: This is a dict that contains at least these entries:
                 ...
                 "pred_boxes": Tensor of dim [batch_size, num_queries, 4] with the predicted box
                 coordinates
        ...
        cost_giou = -generalized_time_iou(box_cxw_to_xlxh(out_bbox), box_cxw_to_xlxh(tgt_bbox))
