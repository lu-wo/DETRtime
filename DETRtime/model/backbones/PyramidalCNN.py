...
class PyramidalCNN(ConvNet):
    """
    The Classifier_PyramidalCNN is one of the simplest convolutional architectures. It implements
    the class ConvNet, which is made of modules with a specific depth, where for each depth the
